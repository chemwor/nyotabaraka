...
export const professionalMissionData: ProfessionalMissionType[] = [
  ...
  },
  {
    ...
    content:
      'We celebrate Kenya’s heritage by blending safaris, coastal escapes, and cultural experiences. Each journey is crafted to share authentic stories and preserve traditions for future generations.',
    icon: strategDevelopment,
  },
]
