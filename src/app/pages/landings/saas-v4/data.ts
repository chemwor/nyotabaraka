...
export const categotySlides: CategorySlideType[] = [
  {
    category: 'Nairobi',
    description: 'Begin your journey with visits to the Giraffe Centre, Elephant Orphanage, and the Nairobi National Museum before settling in at Eka Hotel.',
    image_src: 'assets/img/trip/nairobi.jpg',
  },
  {
    category: 'Safari',
    description: 'Stay at Salt Lick Safari Lodge and experience morning and evening game drives in Tsavo, where elephants, lions, and giraffes roam freely.',
    image_src: 'assets/img/trip/safari.jpg',
  },
  {
    category: 'Taita Community',
    description: 'Immerse yourself in Taita traditions with music, dance, storytelling, and crafts that share the rich history of the region.',
    image_src: 'assets/img/trip/taita.jpg',
  },
  {
    category: 'Maasai Cultural Visit',
    description: 'Learn the art of Maasai beadwork, step into a traditional boma, and connect with one of Kenya’s most celebrated cultures.',
    image_src: 'assets/img/trip/maasai.jpg',
  },
  {
    category: 'Mombasa Coast',
    description: 'Relax at Sarova Whitesands, explore Old Town and Fort Jesus, enjoy a dhow dinner cruise, and snorkel at Wasini Island.',
    image_src: 'assets/img/trip/mombasa.jpg',
  },
]
