...
export const counterData: CounterType[] = [
  {
    ...
    title:
      'Wake Up in the Wild',
    description:
      'Your safari begins in the heart of Tsavo at Salt Lick Safari Lodge, one of Kenya’s most unique wildlife lodges. Perched on stilts above a busy waterhole, you can watch elephants, buffalo, and antelope gather right outside your window. Morning and evening game drives bring you into the savanna where lions, giraffes, and countless bird species roam freely. Every moment is designed to give you an authentic experience of Kenya’s incredible wildlife.',
    statistics: {
      leads: '1000+',
      revenueIncrease: '160%',
      salesChannels: '12+',
  ...
  {
    id: '#image2',
    title: 'Relax on the Swahili Coast',
    description:
      'After the thrill of the safari, you will journey to the coast and stay at Sarova Whitesands in Mombasa, a five-star resort on the Indian Ocean. Spend your days by the pool or on the beach, walk through the historic streets of Mombasa Old Town, and take in the sights of Fort Jesus. Evenings are filled with the aroma of Swahili dishes, sunsets over the ocean, and the gentle sound of waves. It is the perfect place to recharge while discovering the beauty of the Kenyan coast.',
    statistics: {
      leads: '1200+',
      revenueIncrease: '130%',
      salesChannels: '14+',
  ...
  },
  {
    ...
    description:
      'Your journey is not only about landscapes but also about people and traditions. Visit a Maasai boma to learn about beadwork and daily life, experience the music and oral history of the Taita community, and join a Swahili cooking class that brings coastal flavors to life. These cultural moments connect you with Kenya’s heritage in a meaningful way while ensuring local communities benefit directly from your visit. Each experience deepens your connection to the country and its people.',
    statistics: {
      leads: '900+',
      revenueIncrease: '150%',
      salesChannels: '10+',
